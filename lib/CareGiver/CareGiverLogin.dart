...
import 'package:grad_pro/CareGiver/CareGiverSignUp.dart';
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Lottie.asset('assets/Animation - 1701988245335.json', width: 200, height: 150),
                      SizedBox(height: 20),
                      Center(
                        child: const Text(
                          "Login \nAs A Care Giver ",
                      ...
                      QROE(t: "Don't have an account ?", w: const CareGiverSignUp(), t1: "Sign up", context: context),
                      TextButton(
                        onPressed: (){
